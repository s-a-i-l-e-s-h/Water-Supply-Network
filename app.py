...
def main():
    ...
    if choice == "HOME":
        ...
        st.subheader(" ")
        st.write("<p style='text-align: center;'> AquaInsight is an advanced GIS tool for mapping, monitoring, and managing water supply. It integrates IoT sensors, real-time monitoring, and user-friendly interfaces.", unsafe_allow_html=True)
        ...
        st.info("Water Usage : 135 litres per day per home")
        st.warning("Current Water Supply Rate : 265 million litres/day")
